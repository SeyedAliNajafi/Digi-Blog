...
function Footer() {
  return (
    <div className="container xl:max-w-screen-xl bg-gray-100 dark:bg-slate-700 rounded-2xl p-4  lg:my-10 px-3">
      <div className="flex flex-col md:flex-row justify-between items-center mx-8 gap-y-">
        <div className="md:w-96 w-80">
          <Logo size="size-24" />
          <p>
            دیجی بلاگ توسط درست سید علی نجفی شده و برای دیدن پروژه های بیشتر به
            پورتفولیو یا گیت هابم مراجعه کنید.
          </p>
          <p>
            دیجی بلاگ یک سایت بلاگ عمومی می باشد در صورت هرگونه انتقاد، پشنهاد
            با نظر با من در میون بذارید.
          </p>
        </div>
        <div
